  ...
  return (
    <div className="flex flex-col h-[calc(100vh-56px)] -mx-6 -my-8 overflow-hidden">
      ...
      <div className="flex items-center gap-3 border-b border-border-subtle bg-background-secondary px-4 py-2.5 shrink-0">
        ...
        {/* AI assist shortcut */}
        <button onClick={() => setRightTab('ai')} className="flex items-center gap-1.5 rounded-md border border-accent-border bg-accent-subtle px-3 py-1.5 text-xs font-medium text-accent hover:bg-accent-subtle/80 transition-colors">
          ...
          <div className="flex-1 overflow-y-auto p-4 scrollbar-hide">
            ...
            {rightTab === 'ai' && (
              <div className="flex flex-col items-center justify-center gap-3 py-10 text-center">
                <div className="flex h-11 w-11 items-center justify-center rounded-xl border border-border-subtle bg-background-tertiary">
                  <Bot size={20} className="text-text-disabled" aria-hidden="true" />
                </div>
                <div>
                  <p className="text-sm font-medium text-text-primary">AI Code Assistant</p>
                  <span className="mt-1 inline-block rounded-full border border-border-subtle bg-background-tertiary px-2 py-0.5 text-2xs font-medium text-text-tertiary">Coming in v1.1</span>
                </div>
                <p className="max-w-[200px] text-2xs text-text-tertiary leading-relaxed">
                  Explain contracts, find bugs, optimize gas and generate tests with an AI pair-programmer for Arc Solidity, arriving in a future release.
                </p>
                <a
